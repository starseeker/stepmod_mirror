...
public class STEPModFrame extends javax.swing.JFrame {
      ...
      */private DefaultMutableTreeNode resourceDocsTreeNode;
       ...
       */private DefaultMutableTreeNode resourceSchemasTreeNode;
       ...
       public void initRepositoryTree() {
           ...
           modulesTreeNode = new DefaultMutableTreeNode("Modules");
       ...
       private void initAllModulesPopupMenu() {
           ...
           clearSelectedModuleNodesMenuItem.addActionListener(new java.awt.event.ActionListener() {
               public void actionPerformed(java.awt.event.ActionEvent evt) {
                   clearAllSelectedPartshash(hasModulesNodes);
               }
           });
       ...
       private void clearAllSelectedPartshash(TreeMap treeMap) {
           DefaultTreeModel treeModel = (DefaultTreeModel)repositoryJTree.getModel();
       ...
       private void clearAllSelectedParts() {
           clearAllSelectedPartshash(hasModulesNodes);
           clearAllSelectedPartshash(hasApplicationProtocolsNodes);
           clearAllSelectedPartshash(hasResourceDocsNodes);
           clearAllSelectedPartshash(hasResourcesNodes);
       }
       ...
       private void viewSelectedParts() {
           viewSelectedPartsHash(hasModulesNodes, modulesTreeNode);
           viewSelectedPartsHash(hasApplicationProtocolsNodes, applicationProtocolsTreeNode);
           viewSelectedPartsHash(hasResourceDocsNodes, resourceDocsTreeNode);
           viewSelectedPartsHash(hasResourcesNodes, resourceSchemasTreeNode);
       }
    ...
    private void initComponents() {
        ...
        viewSelectedButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/stepmod/resources/box_selected.png")));
        viewSelectedButton.setToolTipText("View all selected parts");
        ...
        jToolBar1.add(viewSelectedButton);
