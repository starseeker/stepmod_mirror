...
3) Run ANT on the build.xml that has just been created:
   ...
   This will create a directory:
     stepmod/ballots/isohtml/activity_class_and_individual
   ...
   be balloted will have been copied into a separate directory for the ballot process:
     stepmod/ballots/isohtml/activity_class_and_individual/express
...
4) Create a zip file of the ballot package.
   ...
   This will create a zip file:
     stepmod/ballots/isohtml/activity_class_and_individual/activity_class_and_individualyyyymmdd.zip
   where 
...
5) If the package is being released for team QC review, convener review or
   ...
   First add the name of the tag and a description to
     stepmod/ballots/isohtml/activity_class_and_individual/activity_class_and_individual/ballot_index.xml
   and check in the file.

   The Tag name should be PLCS_activity_class_and_individual_<date>
