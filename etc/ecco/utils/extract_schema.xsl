...
<xsl:template match="constant_decl/term">
  ...
  <xsl:template match="base_type/entity_ref | base_type/type_ref |formal_parameter/entity_ref">
...
<xsl:template match="general_array_type">
    <xsl:element name="aggregate">
      ...
      <xsl:attribute name="upper">?</xsl:attribute>
    </xsl:element>
</xsl:template>
...
<xsl:template match="local_variable_block">
      <xsl:apply-templates />
</xsl:template>
<xsl:template match="local_variable_decl">
      <xsl:apply-templates />
</xsl:template>
...
<xsl:template match="function_decl">
   <xsl:element name="function">
    ...
    <xsl:element name="algorithm">
      <xsl:apply-templates select="algorithm_head|statement_block"/>
    </xsl:element>
    </xsl:element>
  </xsl:template>
...
<xsl:template match="alias_stmt | assignment_stmt | case_stmt | statement_block | escape_stmt | if_stmt | null_stmt | procedure_call_stmt | repeat_stmt | return_stmt | skip_stmt">
      <xsl:apply-templates />
</xsl:template>
...
<xsl:template match="interval_high_exclusive">
      <xsl:apply-templates />
</xsl:template>

<xsl:template match="interval_high_inclusive">
      <xsl:apply-templates />
</xsl:template>
<xsl:template match="interval_item">
      <xsl:apply-templates />
</xsl:template>
<xsl:template match="interval_low_exclusive">
      <xsl:apply-templates />
</xsl:template>
