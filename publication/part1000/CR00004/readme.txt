...
3) CVS tag the repository using CR00004 as the tag
...
4) Run ANT on the build.xml that has just been created:
   ...
   This will create a directory:
     stepmod/publication/isopub/CR00004

5) The HTML for each part to be published will be generated and stored in 
     stepmod/publication/isopub/CR00004/part1000
   The directory:
     stepmod/publication/isopub/CR00004/part1000/data/modules
     contains the modules
   The directory:
     stepmod/publication/isopub/CR00004/part1000/data/resources
     contains the integrated resources schemas referenced by the modules
   The directory:
     stepmod/publication/isopub/CR00004/part1000/express
     contains the EXPRESS for all the modules and integrated resources schemas.
   The complete directory:
     stepmod/publication/isopub/CR00004/part1000
   is added to the zip file: 
     stepmod/publication/isopub/CR00004/CR00004<YYYYMMDD>.zip
