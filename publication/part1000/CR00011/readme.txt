...
3) CVS tag the repository using CR00011 as the tag
...
5) The HTML for each part to be published will be generated and stored in 
   ...
   The directory:
     stepmod/publication/isopub/CR00011/part1000/data/resources
     contains the integrated resources schemas referenced by the modules
   The directory:
     stepmod/publication/isopub/CR00011/part1000/express
