...
<!--  $Id: build.xsl,v 1.42 2013/02/07 01:54:14 mikeward Exp $
	...
	<xsl:choose>
	  ...
	  <xsl:when test="''" >
		<xsl:message>
		  ************************************************************
		  ABORTING THE BUILD
		  The file publication_index.xml is referencing modules, resource document
...
<!-- BOM -->
   ...
   <xsl:template match="module" mode="target_publish_isomodules">
	...
	<!-- edit which allows for publication of multiple parts within same package --> 
	 ...
	 <xsl:element name="zip">
	   <xsl:attribute name="zipfile">
		 <xsl:value-of select="concat('${PUBDIR}/zip/iso10303_',$module_xml/module/@part,'.zip')"/>
	   </xsl:attribute>
	   <xsl:attribute name="basedir">
		 <xsl:value-of select="$module_dir"/>
	   </xsl:attribute>
   ...
   <xsl:template match="module" mode="copy_express">
	 ...
	 <xsl:if test="$module_xml/module/arm_lf">
	   ...
	   <xsl:element name="copy">
		 ...
		 <xsl:attribute name="tofile">
		   <xsl:value-of select="concat($express_dir1,$prefix,$wg.number.arm_lf,'arm_lf.exp')"/>
		 </xsl:attribute>
	   </xsl:element>
	 </xsl:if>
	 ...
	 <xsl:if test="$module_xml/module/mim_lf">
	   ...
	   <xsl:element name="copy">
		 ...
		 <xsl:attribute name="tofile">
		   <xsl:value-of select="concat($express_dir1,$prefix,$wg.number.mim_lf,'mim_lf.exp')"/>
		 </xsl:attribute>
	   </xsl:element>
	 </xsl:if>
   </xsl:template>
  ...
  <xsl:template match="module" mode="pub_record_style">
   ...
   <xsl:element name="loadfile">
    ...
    <xsl:element name="xslt">
      ...
      <xsl:attribute name="out">
        <xsl:value-of select="concat('${TMPDIR}/data/modules/',@name,'/publication_record.xml')"/>
      </xsl:attribute>
      <xsl:attribute name="style">
  ...
  <xsl:template match="ap_doc" mode="pub_record_style">
   ...
   <xsl:element name="loadfile">
    ...
    <xsl:element name="xslt">
      ...
      <xsl:attribute name="out">
        <xsl:value-of select="concat('${TMPDIR}/data/application_protocols/',@name,'/publication_record.xml')"/>
      </xsl:attribute>
      <xsl:attribute name="style">
        <xsl:value-of select="'${STEPMODSTYLES}/publication/pub_record.xsl'"/>
      </xsl:attribute>        
  ...
  <xsl:template match="res_doc" mode="pub_record_style">
   ...
   <xsl:element name="loadfile">
    ...
    <xsl:element name="xslt">
      ...
      <xsl:attribute name="out">
        <xsl:value-of select="concat('${TMPDIR}/data/resource_docs/',@name,'/publication_record.xml')"/>
      </xsl:attribute>
      <xsl:attribute name="style">
        <xsl:value-of select="'${STEPMODSTYLES}/publication/pub_record.xsl'"/>
      </xsl:attribute>        
...
<!-- Generates the style task for generating the publication record for a
  ...
  <xsl:template match="resource" mode="pub_record_style">
    ...
    <xsl:element name="xslt">
      ...
      <xsl:attribute name="out">
        <xsl:value-of select="concat('${TMPDIR}/data/resources/',$res_name,'/publication_record.xml')"/>
      </xsl:attribute>
      <xsl:attribute name="style">
        <xsl:value-of select="'${STEPMODSTYLES}/publication/pub_record.xsl'"/>
      </xsl:attribute>        
  ...
  <xsl:template match="publication_index" mode="target_finish">
    ...
    <xsl:element name="target">
      ...
      <xsl:attribute name="description">remove the temporary files and zip
      the results.</xsl:attribute>
