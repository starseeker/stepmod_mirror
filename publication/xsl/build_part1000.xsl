...
<xsl:stylesheet
	...
	<xsl:choose>
	  ...
	  <xsl:when test="''" >
		<xsl:message>
		  ************************************************************
		  ABORTING THE BUILD
		  The file part1000.publication_index.xml is referencing modules, resource document
		  or APs that have errors
		  ************************************************************
		</xsl:message>
	  </xsl:when>
	  <xsl:otherwise>
		...
		<project
			...
			name="part1000_publication" default="all" basedir="../../..">
		  <xsl:text>
		  </xsl:text>
  ...
  <xsl:template match="part1000.publication_index" mode="apdoc_variables">
	<xsl:element name="property">
	  ...
	  <xsl:attribute name="value">
		<xsl:value-of select="concat('data/application_protocols/',./application_protocols/ap_doc/@name)"/>
	  </xsl:attribute>
	</xsl:element>
	...
	<target name="isoindex" depends="init" 
	  ...
	  <xsl:element name="xslt">
		...
		<xsl:attribute name="style">
			<xsl:value-of select="'${PUBSRCSTYLES}/part1000_publication_summary.xsl'"/>
		</xsl:attribute>
  ...
  <xsl:template match="part1000.publication_index" mode="target_isodepmodules">
	...
	<target
		xsl:extension-element-prefixes="exslt"        
		name="isodepmodules" depends="init, isodepmodules_publication_record" 
   ...
   <xsl:template match="part1000.publication_index" mode="dependent_modules_target_style_attributes">
	 <xsl:param name="menu"/>
	 <xsl:attribute name="destdir">
	   <xsl:value-of select="'${P1000DIR}'"/>
	 </xsl:attribute>
   ...
   <xsl:template match="part1000.publication_index"
	 mode="apdocs_target_style_attributes">
	 <xsl:param name="menu"/>
	 <xsl:attribute name="destdir">
	   <xsl:value-of select="'${P1000DIR}'"/>
	 </xsl:attribute>
   ...
   <xsl:template match="part1000.publication_index" mode="target_resources_publication_record">
	 ...
	 <xsl:variable name="resdoc_schema_node_set"
	   select="exslt:node-set($resdoc_schema)"/>
	 <xsl:text>
	 </xsl:text>
	 <xsl:element name="target">
 ...
 -->
   ...
   <!-- called from template match="part1000.publication_index" mode="target_isoresdocs" -->
   <xsl:template match="part1000.publication_index"
   ...
   <xsl:template match="part1000.publication_index" mode="target_publish_isoapdocs">
	 ...
	 <xsl:element name="target">
	   ...
	   <xsl:attribute name="depends">isoindex, resources, isodepmodules, isoapdoc</xsl:attribute>
   ...
   <xsl:template match="ap_doc" mode="target_publish_isoapdocs">
	 ...
	 <xsl:variable name="apdoc_iso_no" select="concat('iso10303_',$apdoc_xml/application_protocol/@part)"/>
	 <xsl:variable name="apdoc_dir" select="concat('${PUBDIR}/',$apdoc_iso_no,'/')"/>

	 <xsl:text>
	 </xsl:text>
	 <xsl:comment>Publish Application protocol: <xsl:value-of select="@name"/> </xsl:comment>
	 ...
	 <xsl:element name="move">
	   <xsl:attribute name="file">
		 <xsl:value-of select="concat('${P1000DIR}/data/application_protocols/',@name,'/sys/abstract.htm')"/>
	   </xsl:attribute>
	   <xsl:attribute name="tofile">
		 <xsl:value-of select="concat($apdoc_dir,'abstracts/abstract_',$apdoc_xml/application_protocol/@part,'.htm')"/>
	   </xsl:attribute>
	 </xsl:element>
	 ...
	 <xsl:element name="zip">
	   <xsl:attribute name="zipfile">
		 <xsl:value-of select="concat('${PUBDIR}/zip/iso10303_',$apdoc_xml/application_protocol/@part,'.zip')"/>
	   </xsl:attribute>
   ...
   <xsl:template match="part1000.publication_index" mode="target_publish_isomodules">
	 ...
	 <xsl:element name="target">
	   ...
	   <xsl:attribute name="description">Copy HTML for modules listed in
   ...
   <xsl:template match="res_doc" mode="target_publish_isoresdocs">
	 <xsl:variable name="resdoc_file" select="concat('../../data/resource_docs/',@name,'/resource.xml')"/>
	 <xsl:variable name="resdoc_xml" select="document($resdoc_file)"/>
	 ...
	 <xsl:element name="move">
	   <xsl:attribute name="file">
		 <xsl:value-of select="concat('${P1000DIR}/data/resource_docs/',@name,'/sys/abstract.htm')"/>
	   </xsl:attribute>
	   <xsl:attribute name="tofile">
		 <xsl:value-of select="concat($resdoc_dir,'abstracts/abstract_',$resdoc_xml/resource/@part,'.htm')"/>
	   </xsl:attribute>
	 </xsl:element>
   ...
   <xsl:template match="resource_docs" mode="target_all">
	 publish_isoresdocs
   </xsl:template>

   <xsl:template match="modules" mode="target_all">
	 publish_isomodules
   </xsl:template>
   ...
   <xsl:template match="modules" mode="present">
	 1
   </xsl:template>

   <xsl:template match="resource_docs" mode="present">
	 2
   </xsl:template>
 ...
 ************************************************************
 ...
 <xsl:template name="get_mod_node_set">
   ...
   <xsl:variable name="todo_schema_list" select="concat(string($aps),string($modules),string($resource_docs))"/>
  ...
  <xsl:template match="module" mode="pub_record_style">
   ...
   <xsl:element name="loadfile">
    ...
    <xsl:element name="xslt">
      ...
      <xsl:attribute name="out">
        <xsl:value-of select="concat('${P1000DIR}/data/modules/',@name,'/publication_record.xml')"/>
      </xsl:attribute>
      <xsl:attribute name="style">
  ...
  <xsl:template match="ap_doc" mode="pub_record_style">
   ...
   <xsl:element name="loadfile">
    ...
    <xsl:element name="xslt">
      ...
      <xsl:attribute name="out">
        <xsl:value-of select="concat('${P1000DIR}/data/application_protocols/',@name,'/publication_record.xml')"/>
      </xsl:attribute>
      <xsl:attribute name="style">
        <xsl:value-of select="'${STEPMODSTYLES}/publication/pub_record.xsl'"/>
      </xsl:attribute>        
  ...
  <xsl:template match="res_doc" mode="pub_record_style">
   ...
   <xsl:element name="loadfile">
    ...
    <xsl:element name="xslt">
      ...
      <xsl:attribute name="out">
        <xsl:value-of select="concat('${P1000DIR}/data/resource_docs/',@name,'/publication_record.xml')"/>
      </xsl:attribute>
      <xsl:attribute name="style">
        <xsl:value-of select="'${STEPMODSTYLES}/publication/pub_record.xsl'"/>
      </xsl:attribute>        
...
<!-- Generates the style task for generating the publication record for a
  ...
  <xsl:template match="resource" mode="pub_record_style">
    ...
    <xsl:variable name="res_file" select="concat('../../data/resources/',$res_name,'/',$res_name,'.xml')"/>
    ...
    <xsl:element name="loadfile">
      ...
      <xsl:attribute name="srcfile">
        <xsl:value-of
          select="concat('data/resources/',$res_name,'/CVS/Entries')"/>
      </xsl:attribute>
    </xsl:element>
    ...
    <xsl:element name="xslt">
      ...
      <xsl:attribute name="out">
        <xsl:value-of select="concat('${P1000DIR}/data/resources/',$res_name,'/publication_record.xml')"/>
      </xsl:attribute>
      <xsl:attribute name="style">
        <xsl:value-of select="'${STEPMODSTYLES}/publication/pub_record.xsl'"/>
      </xsl:attribute>        
