...
var apClauses = new Array("introduction", "1_scope", "2_refs", "3_defs", "4_info_reqs",
			  "5_main", "6_ccs", "contents", "cover", "isocover", "biblio", "foreword", 
			  "abstract",
			  "annex_exp_lf", "annex_shortnames", "annex_imp_meth",
			  "annex_pics", "annex_obj_reg", "annex_aam", "annex_arm_expg", "annex_comp_int",
			  "annex_mim_expg", "annex_guide", "annex_tech_disc", "annex_changes", "help","index_apdoc");

var apFrames = new Array("frame_aptitle", "frame_toc", "frame_toc_short", "frame_contenttitle", "frame_index");

var apIndexes = new Array("index_arm_modules",
			  "index_arm_modules_top",
			  "index_arm_modules_inner",
			  "index_arm_modules_inner_part",
			  "index_mim_modules",
			  "index_mim_modules_top",
			  "index_mim_modules_inner",
			  "index_mim_modules_inner_part",
			  "index_resources",
			  "index_resources_top",
			  "index_resources_inner",
			  "index_resources_inner_part",
			  "index_arm_express",
			  ...
			  "index_arm_express_nav",
			  "index_arm_express_nav_top",
			  "index_arm_express_nav_inner"
			  );
...
function MakeReadme(apDoc) {
	...
	ts.WriteLine("$Id: mkapdoc_main.js,v 1.23 2004/11/12 07:49:20 robbod Exp $");
	ts.WriteLine("");
	ts.WriteLine("      -----------------------------");
...
function MakeDvlpFldr(apDoc, update) {
	...
	ts.WriteLine("<?xml version=\"1.0\" encoding=\"UTF-8\"?>");
	ts.WriteLine("<!-- $Id: mkapdoc_main.js,v 1.23 2004/11/12 07:49:20 robbod Exp $ -->");
	ts.WriteLine("<?xml-stylesheet type=\"text/xsl\" href=\"../../../../xsl/projmg/apdoc_issues_file.xsl\"?>");
...
function MakeApAamXML(apDoc) {
    ...
    ts.WriteLine("      -->");
    ts.WriteLine("<idef0 application_protocol=\""+apDoc+"\">");
...
function MakeApDocXML(apDoc, title, partNo, module_name, new_edition, purpose) {
    ...
    ts.WriteLine("    <p>@@@@ abstract statement @@@@</p>");
    ts.WriteLine(" </abstract>");
    ts.WriteLine("");
    if (new_edition == true) {
...
//MakeSysFldr("configuration_control_3d_design_ed2","ap239_product_life_cycle_support");
//MakeApDocClause("product_life_cycle_support", "isocover", "ap239_product_life_cycle_support");
//MakeApDocClause("configuration_control_3d_design_ed2", "isocover", "configuration_control_3d_design_ed2");
