//$Id: mkapdoc_main.js,v 1.7 2003/05/23 09:47:41 nigelshaw Exp $
...
var apClauses = new Array("1_scope", "2_refs", "3_defs", "4_info_reqs",
			  "5_main", "6_ccs",
			  "a_exp_lf", "b_shortnames", "c_imp_meth", "biblio",
			  "d_pics", "contents", "cover", "e_obj_reg",
			  "f_aam", "f_arm_expg", "foreword", "g_exp",
...
function MakeDvlpFldr(apDoc, update) {
	...
	ts.WriteLine("<!-- $Id: mkapdoc_main.js,v 1.7 2003/05/23 09:47:41 nigelshaw Exp $ -->");
...
function MakeDataPlan(apDoc, imgfile, title) {
    var ForReading = 1, ForWriting = 2, ForAppending = 8;
    var TristateUseDefault = -2, TristateTrue = -1, TristateFalse = 0;
    var apDocFldr = GetApDocDir(apDoc);
    ...
    ts.WriteLine("<?xml version=\"1.0\" encoding=\"UTF-8\"?>");
    ts.WriteLine("<!-- $Id: mkmodule.js,v 1.35 2003/04/23 14:36:26 robbod Exp $ -->");
...
function MakeApDocXML(apDoc, title, partNo, module_name, new_edition, purpose) {
    ...
    ts.WriteLine("   <projlead ref=\"@@@@\"/>");
    ts.WriteLine("   <editor ref=\"@@@@\"/>");
    ts.WriteLine(" </contacts>");
    ts.WriteLine("");
    ...
    ts.WriteLine(" <aam>");
    ts.WriteLine("   <idef0>");
    ts.WriteLine("     <imgfile file=\"@@@@\" title=\"@@@@\"/>");
    ts.WriteLine("   </idef0>");
    ts.WriteLine(" </aam>");
    ts.WriteLine("");
...
function MakeApDoc(apDoc, title, partNo, module_name, new_edition, purpose) {
	...
	MakeDataPlan(apDoc, "data_plan_intro1.xml");
	MakeDataPlan(apDoc, "data_plan_detail1.xml");
