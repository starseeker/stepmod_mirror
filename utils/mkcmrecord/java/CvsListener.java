...
public class CvsListener extends CVSAdapter {
    ...
    private CvsOutputProcessor processor;
    
    public CvsListener(CvsOutputProcessor processor) {
    ...
    public void messageSent(MessageEvent e) {
        ...
        if (e.isTagged()) {
            ...
            if (message != null) {
                // System.err.println("TAGGED MESSAGE> " + message);
		processor.putLine(message);
            }
        }
        else {
	    // System.err.println("MESSAGE> " + line);
	    processor.putLine(line);
	}
    }
    ...
    public void messageSent(BinaryMessageEvent e) {
        ...
        System.err.println("Binary message ignored.");
