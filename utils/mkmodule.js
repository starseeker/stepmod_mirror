//$Id: mkmodule.js,v 1.36 2003/07/23 15:37:15 robbod Exp $
...
function MakeNavFile(file, module, stylesheet, body) {
	...
	ts.WriteLine("<!-- $Id: mkmodule.js,v 1.36 2003/07/23 15:37:15 robbod Exp $ -->");
...
function MakeExpressXML(module, armOrMim) {
    ...
    ts.WriteLine("   rcs.date=\"$Date: 2003/07/23 15:37:15 $\"");
    ts.WriteLine("   rcs.revision=\"$Revision: 1.36 $\">");
    var schema = schemaName(module,armOrMim);
