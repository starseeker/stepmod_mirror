//$Id: mkmodule.js,v 1.42 2004/10/25 20:23:34 thendrix Exp $
...
function MakeNavFile(file, module, stylesheet, body) {
	...
	ts.WriteLine("<!-- $Id: mkmodule.js,v 1.42 2004/10/25 20:23:34 thendrix Exp $ -->");
...
function MakeExpressXML(module, armOrMim) {
    ...
    ts.WriteLine("   rcs.date=\"$Date: 2004/10/25 20:23:34 $\"");
    ts.WriteLine("   rcs.revision=\"$Revision: 1.42 $\">");
    var schema = schemaName(module,armOrMim);
