...
function MakeNavFile(file, module, stylesheet, body) {
	...
	ts.WriteLine("<!-- $Id: mkmodule.js,v 1.41 2004/10/11 20:17:49 thendrix Exp $ -->");
...
function MakeExpressXML(module, armOrMim) {
    ...
    ts.WriteLine("   rcs.date=\"$Date: 2004/10/11 20:17:49 $\"");
    ts.WriteLine("   rcs.revision=\"$Revision: 1.41 $\">");
    var schema = schemaName(module,armOrMim);
