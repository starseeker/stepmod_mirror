//$Id: mkballot_main.js,v 1.10 2002/12/24 15:35:33 robbod Exp $
...
function mkBallotXsl(ballot,xsl,xml) {
    ...
    ts.WriteLine("<!-- ");
    ts.WriteLine("$Id: mkballot_main.js,v 1.10 2002/12/24 15:35:33 robbod Exp $");
