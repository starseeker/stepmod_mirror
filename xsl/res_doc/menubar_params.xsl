...
<!--
     $Id: menubar_params.xsl,v 1.5 2002/08/07 12:09:14 robbod Exp $

     Author: Tom hendrix adapted from version for modules 
     Rob Bodington, Eurostep Limited
  
  Owner:  Developed by Eurostep
  Purpose: 
     Used to identify the menubar displayed at the top of resource documents.
...
>
  ...
  <!--   -->
  <xsl:param name="menubar_file" select="'./data/resource_docs/menubar_default.xml'"/>
